...
O Produtor não quer produto, quer solução!!</p>
          ...
          duration: 0.6,
          delay: 0.6
        }} className="text-center text-xl md:text-2xl font-serif text-gold">É exatamente isso que o AgroMentor desenvolve.<span className="font-bold">AgroMentor</span> desenvolve.
          </motion.p>
        </div>
      </div>
    </section>;
