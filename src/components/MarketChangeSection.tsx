...
const capabilities = [
  { icon: Target, text: "Diagnosticar problemas reais" },
  { icon: MessageSquare, text: "Comunicar valor" },
  { icon: Handshake, text: "Construir confiança" },
  { icon: Users, text: "Atuar como parceiro estratégico do cliente" },
];
      ...
      <div className="container mx-auto px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <motion.p
            ...
            className="text-center text-xl md:text-2xl font-serif text-gold"
          >
            É exatamente isso que o <span className="font-bold">AgroMentor</span> desenvolve.
          </motion.p>
        </div>
      </div>
    </section>
