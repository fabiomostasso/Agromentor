...
Você profissional do Agronegócio precisa mudar junto.</span>
          ...
          delay: 0.2
            ...
            <p className="text-lg md:text-xl text-cream-muted leading-relaxed">Produtos viraram commodities. A informação está disponível. O cliente compara, questiona e escolhe. O Produtor não quer apenas produto, preço e tapinha nas costas. 
Ele quer SOLUÇÃO!!</p>
