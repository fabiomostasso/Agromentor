...
Você profissional do Agronegócio precisa mudar junto.</span>
          ...
          duration: 0.6,
          delay: 0.6
        }} className="text-center text-xl md:text-2xl font-serif text-gold">É exatamente isso que o Programa AgroMentor pode desenvolver em você e te tornar mais confiável e respeitado.
          </motion.p>
        </div>
      </div>
    </section>;
