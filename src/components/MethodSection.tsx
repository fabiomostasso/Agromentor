...
const MethodSection = () => {
  return (
    <section id="metodo" className="py-20 lg:py-28 bg-forest-deep relative">
      ...
      <div className="container mx-auto px-6">
        ...
        >
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-serif font-bold text-cream mb-4">
            O Método <span className="text-gradient-gold">AgroMentor</span>
          </h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {pillars.map((pillar, index) => (
            <motion.div
              ...
              className={`relative p-8 rounded-2xl bg-forest border border-gold/20 hover:border-gold/40 transition-all duration-300 group ${
