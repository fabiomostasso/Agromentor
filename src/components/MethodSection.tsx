  ...
  return <section id="metodo" className="py-20 lg:py-28 bg-forest-deep relative">
      ...
      <div className="container mx-auto px-6">
        ...
        duration: 0.6
          ...
          <p className="text-lg text-cream-muted max-w-2xl mx-auto mt-4">O Programa AgroMentor é estruturado em um método próprio, desenvolvido ao longo de anos de atuação no agronegócio, de muita observação e de muitos casos de sucesso. Está baseado em cinco pilares fundamentais:</p>
