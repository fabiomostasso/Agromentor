...
const highlights = [{
  icon: Award,
  text: "Mais de 30 anos ininterruptos de vivência no agronegócio"
}, {
  icon: Briefcase,
  text: "Experiência em grandes empresas nacionais e multinacionais de insumos e serviços"
}, {
  icon: Users,
  text: "Atuação na gestão comercial de grandes contas e clientes, distribuidores e cooperativas"
}, {
  icon: TrendingUp,
  text: "Vivência em P&D, Produção Industrial, Marketing, Desenvolvimento de Mercado, Vendas e Consultorias"
}];
const AboutSection = () => {
  return <section className="py-20 lg:py-28 bg-forest-deep relative overflow-hidden">
      {/* Decorative elements */}
          ...
          <div className="grid lg:grid-cols-5 gap-8 items-center">
            ...
            delay: 0.2
              ...
              <div className="relative">
                <div className="w-64 h-64 lg:w-72 lg:h-72 rounded-2xl border-2 border-gold/30 overflow-hidden shadow-2xl">
                  <img src={mentorPhoto} alt="Fábio Mostasso - Engenheiro Agrônomo" className="w-full h-full object-cover object-top" />
                </div>
                {/* Golden accent */}
            ...
            delay: 0.3
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                {highlights.map((item, index) => <div key={index} className="flex items-center gap-3 p-3 rounded-lg bg-forest-deep/50 border border-gold/10">
              ...
              <div className="flex items-center gap-4 mt-6 p-4 rounded-lg bg-forest-deep/50 border border-gold/10">
                <a href="https://www.linkedin.com/in/fabiomostasso/" target="_blank" rel="noopener noreferrer" className="flex-shrink-0 w-10 h-10 flex items-center justify-center rounded-full border-2 border-gold text-gold hover:bg-gold hover:text-forest-deep transition-colors">
                  <Linkedin className="w-5 h-5" />
                </a>
                <p className="text-cream-muted text-base font-bold">
                  Conheça mais da carreira profissional do seu Mentor do Agronegócio em seu{" "}
                  <a href="https://www.linkedin.com/in/fabiomostasso/" target="_blank" rel="noopener noreferrer" className="text-gold hover:text-gold/80 underline underline-offset-2 transition-colors">
                    perfil do LinkedIn
                  </a>.
                </p>
              </div>
