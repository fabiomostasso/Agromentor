...
const CTASection = () => {
  return (
    <section id="cta" className="py-20 lg:py-32 bg-forest-deep relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-cream-muted leading-relaxed mb-8 max-w-2xl mx-auto">
            Se você sente que está pronto para subir de nível profissional e deixar de ser 
            apenas mais um no mercado, o <span className="text-gold font-semibold">Fundamentos do Consultor AgroMentor</span> é 
          ...
          >
            <Button 
              variant="premium" 
              size="xl" 
              className="text-lg px-12 py-6 h-auto gold-glow group"
              asChild
            >
