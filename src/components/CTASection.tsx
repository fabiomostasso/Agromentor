      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        duration: 0.6
          ...
          <p className="text-lg md:text-xl text-cream-muted leading-relaxed mb-8 max-w-2xl mx-auto">
            Se você sente que está pronto para subir de nível profissional e deixar de ser apenas mais um mero vendedor no mercado do agronegócio, o Fundamentos do Consultor AgroMentor é o seu ponto de partida.
          </p>
