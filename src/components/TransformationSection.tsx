...
const transformations = [
  { from: "De vendedor de produto", to: "consultor de confiança" },
  { from: "De disputa por preço", to: "defesa de valor" },
  { from: "De relação pontual", to: "parceria de longo prazo" },
  { from: "De profissional substituível", to: "profissional indispensável" },
];
