...
const transformations = [{
  ...
  to: "Consultor Técnico de confiança"
}, {
  ...
  return <section className="py-20 lg:py-28 bg-forest relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        duration: 0.6
          ...
          <p className="text-lg text-cream-muted max-w-3xl mx-auto mt-6">Ao longo do programa, você deixa de ser apenas mais um vendedor de commodities no mercado e passa a atuar, e ser reconhecido, como <span className="text-gold font-semibold">Consultor Técnico Estratégico</span>​
          </p>
